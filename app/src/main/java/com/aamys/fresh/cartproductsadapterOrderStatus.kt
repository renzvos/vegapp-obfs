...
class cartproductsadapter(context: Context,cartClicks: OrderLayoutDesign.SimpleLayoutCallback) :
    RecyclerView.Adapter<cartproductsadapter.ViewHolder>() {
    private var cart: ArrayList<CartitemParams>?
    var context: Context
    var callbacks = cartClicks

    fun Update(items: ArrayList<CartitemParams>?) {
        Log.i("ABCDE", "Update: ")
        cart = items
    }
    ...
    override fun onCreateViewHolder(
        ...
        val listItem: View =
            layoutInflater.inflate(R.layout.cartitemorder, parent, false)
