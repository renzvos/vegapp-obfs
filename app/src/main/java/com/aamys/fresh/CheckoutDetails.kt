...
class CheckoutDetails (){
    ...
    fun ProduceLayout(view : View , Payicon : Drawable)
    {
     ...
     fun NewDeliveryField(detailObject: DetailObject)
    {
        val attachview = rootofdeliverycontent
        detailObject.id = objects.size
        objects.add(detailObject)
        val msg_view: View = inflator!!.inflate(detailObject.getLayout(), attachview, false)
        detailObject.InitialisationFromView(msg_view)
        detailObject.StartUp()
    ...
    {
        fun OnEdit(objects: ArrayList<DetailObject>)
