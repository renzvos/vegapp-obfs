...
import com.aamys.fresh.AuthMethodPickerLayout;
import com.aamys.fresh.AuthUI;
import com.aamys.fresh.AuthUI.IdpConfig;
...
import com.aamys.fresh.data.remote.AnonymousSignInHandler;
import com.aamys.fresh.data.remote.EmailSignInHandler;
...
import com.aamys.fresh.data.remote.PhoneSignInHandler;
...
import static com.aamys.fresh.util.ExtraConstants.GENERIC_OAUTH_BUTTON_ID;
import static com.aamys.fresh.util.ExtraConstants.GENERIC_OAUTH_PROVIDER_ID;
import static com.aamys.fresh.AuthUI.EMAIL_LINK_PROVIDER;
        ...
        mHandler.getOperation().observe(this, new ResourceObserver<IdpResponse>(
            ...
            protected void onFailure(@NonNull Exception e) {
                ...
                if (e instanceof FirebaseAuthAnonymousUpgradeException) {
                    ...
                    finish(Activity.RESULT_CANCELED, IdpResponse.from(fue).toIntent());
                } else {
            ...
            switch (providerId) {
                ...
                default:
                    if (!TextUtils.isEmpty(
                            idpConfig.getParams().getString(ExtraConstants.GENERIC_OAUTH_PROVIDER_ID))) {
