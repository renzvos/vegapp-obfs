package com.example.vegapp.util.data;
...
import static com.example.vegapp.util.data.EmailLinkParser.LinkParameters.ANONYMOUS_USER_ID_IDENTIFIER;
import static com.example.vegapp.util.data.EmailLinkParser.LinkParameters.FORCE_SAME_DEVICE_IDENTIFIER;
import static com.example.vegapp.util.data.EmailLinkParser.LinkParameters.PROVIDER_ID_IDENTIFIER;
import static com.example.vegapp.util.data.EmailLinkParser.LinkParameters.SESSION_IDENTIFIER;
