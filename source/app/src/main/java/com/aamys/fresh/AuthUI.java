...
public final class AuthUI {
    ...
    private AuthUI(FirebaseApp app) {
        ...
        try {
            mAuth.setFirebaseUIVersion("8.0.0");
        } catch (Exception e) {
