...
import com.aamys.fresh.util.ui.TextHelper;
import com.aamys.fresh.viewmodel.ResourceObserver;
import com.aamys.fresh.viewmodel.email.WelcomeBackPasswordHandler;
            ...
            protected void onFailure(@NonNull Exception e) {
                ...
                if (e instanceof FirebaseAuthException) {
                    ...
                    if (error == FirebaseAuthError.ERROR_USER_DISABLED) {
                        ...
                        finish(Activity.RESULT_CANCELED, resp.toIntent());
                        return;
                    }
                }
