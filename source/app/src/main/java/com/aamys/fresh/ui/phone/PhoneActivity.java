...
import com.aamys.fresh.data.model.PhoneNumberVerificationRequiredException;
import com.aamys.fresh.data.model.User;
import com.aamys.fresh.ui.AppCompatBase;
import com.aamys.fresh.ui.FragmentBase;
import com.aamys.fresh.ui.HelperActivityBase;
import com.aamys.fresh.util.ExtraConstants;
import com.aamys.fresh.util.FirebaseAuthError;
import com.aamys.fresh.viewmodel.ResourceObserver;
import com.aamys.fresh.viewmodel.phone.PhoneProviderResponseHandler;
...
public class PhoneActivity extends AppCompatBase {
    ...
    private String getErrorMessage(FirebaseAuthError error) {
        if(error == FirebaseAuthError.ERROR_INVALID_PHONE_NUMBER)
        { return getString(R.string.fui_invalid_phone_number); }
        else if(error == FirebaseAuthError.ERROR_TOO_MANY_REQUESTS)
        { return getString(R.string.fui_error_too_many_attempts); }
        else if(error == FirebaseAuthError.ERROR_QUOTA_EXCEEDED)
        { return getString(R.string.fui_error_quota_exceeded); }
        else if(error == FirebaseAuthError.ERROR_INVALID_VERIFICATION_CODE)
        { return getString(R.string.fui_incorrect_code_dialog_body); }
        else if(error == FirebaseAuthError.ERROR_SESSION_EXPIRED)
